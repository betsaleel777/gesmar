                    ...
                    <div class="card">
                        <div class="card-header tx-medium">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <form action="{{ route('admin.role.add') }}" method="get">
                                ...
                                <div class="col-md-2">
                                    <form action="{{ route('admin.role.archive') }}" method="get">
                                        <button class="btn btn-primary btn-icon btn-block btn-sm">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-1">
                                                        <a href="#modal{{ $role->id }}" data-toggle="modal">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <p class="mg-b-0">Voulez vous réelement supprimer
                                                                    le rôle <b>{{ $role->name }}</b>
                                                                </p>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-primary"
                                                                    data-dismiss="modal">Close</button>
                                                                <a href="{{ route('admin.role.trash', $role->id) }}"
