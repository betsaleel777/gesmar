...
return [
    'parametre' => [
        'architecture' => [
            'acces' => 'accéder à l\'architecture du marché',
            'site' => [
                'acces' => 'accéder aux sites',
            ...
            'emplacement' => [
                'acces' => 'accéder aux emplacements',
        ...
        'administration' => [
            'acces' => 'accéder à utilisateurs et fonctions',
            'user' => [
                'acces' => 'accéder aux utilisateurs',
                'create' => 'créer utilisateurs',
                'global' => 'voir tout les utilisateurs',
                'own' => 'utilisateurs visible par le créateur uniquement',
                'edit' => 'modifier utilisateur',
                'trash' => 'archiver utilisateur',
                'restore' => 'restorer utilisateur',
            ],
            'role' => [
                'acces' => 'accéder aux roles',
                'create' => 'créer role',
                'global' => 'voir tout les role',
                'own' => 'role visible par le créateur uniquement',
                'edit' => 'modifier un role',
                'trash' => 'archiver un role',
                'restore' => 'restorer un role',
            ],
            'permission' => [
                'acces' => 'accéder aux permissions',
            ],
        ],
        'operation' => [],
        'tarifs' => [],
